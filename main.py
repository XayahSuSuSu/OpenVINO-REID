...
from utils.python import monitors
...
def main():
    args = {
        ...
        'device': 'CPU',
        'history_file': '',
        'input': ['face-demographics-walking-and-pause.mp4'],
        'loop': False,
        'm_detector': 'intel/person-detection-retail-0013/FP32/person-detection-retail-0013.xml',
        'm_reid': 'intel/person-reidentification-retail-0288/FP16/person-reidentification-retail-0288.xml',
        'm_segmentation': None,
        'no_show': False,
        'output_video': '',
        'save_detections': '',
